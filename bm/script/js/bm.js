...
var Game = /** @class */ (function () {
    ...
    Game.calcTeamStats = function (teamId, gameData) {
        ...
        for (var i = 0; i < 5; i++) {
            ...
            var rbd = Math.round(reboundModifier(i, p.skillPass) * RandomUtil.random(0, 12));
            var tov = Math.round(turnoverModifier(i, p.skillPass) * RandomUtil.random(0, 5));
            var stl = Math.round(stealModifier(i, p.skillPass) * RandomUtil.random(0, 5));
            var blk = Math.round(blockModifier(i, p.skillPass) * RandomUtil.random(0, 5));
            if (gameData.currentDay <= this.regularEndDay) {
        ...
        for (var i = 0; i < bench.length; i++) {
            ...
            var ast = Math.round(assistModifier(p.positionFirst, p.skillPass) * RandomUtil.random(0, 20) * RandomUtil.random(0, 0.4));
            var rbd = Math.round(reboundModifier(p.positionFirst, p.skillPass) * RandomUtil.random(0, 25) * RandomUtil.random(0, 0.4));
            var tov = Math.round(turnoverModifier(p.positionFirst, p.skillPass) * RandomUtil.random(0, 10) * RandomUtil.random(0, 0.4));
            var stl = Math.round(stealModifier(p.positionFirst, p.skillPass) * RandomUtil.random(0, 10) * RandomUtil.random(0, 0.4));
            var blk = Math.round(blockModifier(p.positionFirst, p.skillPass) * RandomUtil.random(0, 10) * RandomUtil.random(0, 0.4));
